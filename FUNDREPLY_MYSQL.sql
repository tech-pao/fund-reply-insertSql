...
CREATE TABLE IF NOT EXISTS AUTO_COLL_FAIL (
  PKID VARCHAR(200) NOT NULL COMMENT '唯一主键编号',
    TRACEID VARCHAR(200) NOT NULL COMMENT '全局流水',
    COLLREQ LONGTEXT COMMENT '采集请求报文',
    COLLRES LONGTEXT COMMENT '采集返回报文',
    ...
    SERVICENAME VARCHAR(500) COMMENT '微服务名称',
    PRIMARY KEY (PKID),
    INDEX fundreplyAUTO_COLL_FAIL_MIX (COLLTIME, PKID, TRACEID),
    INDEX fundreplyIDXTRACEID_FAIL (TRACEID)
) COMMENT='流量采集失败表';

ALTER TABLE AUTO_COLL_FAIL
  MODIFY COLUMN TRACEID VARCHAR(200) NOT NULL DEFAULT ' ' COMMENT '全局流水';